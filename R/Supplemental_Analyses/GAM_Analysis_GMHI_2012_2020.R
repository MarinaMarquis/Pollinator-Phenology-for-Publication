...
# Save the plots 
ggsave("Figures/GAM_onset_species_GHMI.png", plot_model_group(onset_species, "onset"), 
       width = 8, height = 8, dpi = 300)

ggsave("Figures/GAM_offset_species_GHMI.png", plot_model_group(offset_species, "offset"), 
       width = 8, height = 8, dpi = 300)

ggsave("Figures/GAM_duration_species_GHMI.png", plot_model_group(duration_species, "duration"), 
