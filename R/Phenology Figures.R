...
######## Figure 1: Plotting slopes of species' change in total duration across range of GHMI for all species
...
######## Figure 2: Plotting slopes of species' onset across range of GHMI for all species
...
######## Figure 3: Plotting slopes of species' offset across range of GHMI for all species
...
######## Figure 4-6: Plotting slopes of species' onset, offset, and duration across range of GHMI 
...
######## Figure 7-9: Total Duration values across a range of GHMI values for 
#        6 species 
...
######## Figure 10-12: Onset values across a range of GHMI values for 
#        10 species 
...
######## Figure 13-15: Offset values across a range of GHMI values for 
#        12 species 
