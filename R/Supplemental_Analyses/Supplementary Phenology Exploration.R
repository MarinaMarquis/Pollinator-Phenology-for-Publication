#### Supplemental Analysis: Investigating Temporal Bias in Phenology Estimates 
...
# Read in the data 
phenology_estimates_all_species_each_grid <- readRDS('Data/Phenology Data/phenology_estimates_by_grid_by_species.RDS')  
...
phenology_estimates_all_species_each_grid_sub <- top_species_data %>%
...
saveRDS(phenology_estimates_all_species_each_grid_sub, "Data/phenology_estimates_sample_subset.RDS")

phenology_estimates_all_species_each_grid_sub <- readRDS("Data/phenology_estimates_sample_subset.RDS")
...
# are using its first name in this df (phenology_estimates_all_species_each_grid_sub) for the 
# subsetted data now 
full_data <- readRDS("Data/Phenology Data/phenology_estimates_by_grid_by_species.RDS") 
...
phenology_estimates_all_species_each_grid_sub <- phenology_estimates_all_species_each_grid_sub %>%
  inner_join(valid_combos_top10, by = c("species", "grid"))

# Save it 
saveRDS(phenology_estimates_all_species_each_grid_sub, "Data/phenology_estimates_of_top_ten_species_for_2012_to_2020.RDS")
...
subset_top <- phenology_estimates_all_species_each_grid_sub %>%
